package com.veyru.dto.response.recommendation;
...
public class RecommendedUserResponse {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (java.lang.Double.compare(this.getSimilarityScore(), other.getSimilarityScore()) != 0)
      return false;
  ...
  public int hashCode() {
    ...
    final long $similarityScore = java.lang.Double.doubleToLongBits(this.getSimilarityScore());
