...
public class MessageController {
  ...
  public ResponseEntity<MessageResult> sendMessage(
      @AuthenticationPrincipal AppUserDetails user, @RequestBody SendMessageRequest request) {
  ...
  public ResponseEntity<Long> getUnreadCount(@AuthenticationPrincipal AppUserDetails user) {
    return ResponseEntity.ok(conversations.getUnreadCount(user.getId()));
  }
  ...
  public ResponseEntity<Map<String, String>> startConversation(
      @AuthenticationPrincipal AppUserDetails user, @PathVariable String otherUserId) {
