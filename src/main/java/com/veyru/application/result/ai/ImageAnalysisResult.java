...
public class ImageAnalysisResult {
  ...
  public boolean equals(final Object o) {
    ...
    final ImageAnalysisResult other = (ImageAnalysisResult) o;
    if (!other.canEqual((Object) this)) return false;
    final Object this$imageDescription = this.getImageDescription();
    final Object other$imageDescription = other.getImageDescription();
    ...
    if (this$sceneType == null ? other$sceneType != null : !this$sceneType.equals(other$sceneType))
      return false;
    final Object this$mood = this.getMood();
    final Object other$mood = other.getMood();
    ...
    if (this$objects == null ? other$objects != null : !this$objects.equals(other$objects))
      return false;
    final Object this$suggestedTags = this.getSuggestedTags();
    final Object other$suggestedTags = other.getSuggestedTags();
    if (this$suggestedTags == null
        ? other$suggestedTags != null
        : !this$suggestedTags.equals(other$suggestedTags)) return false;
    final Object this$captionSuggestions = this.getCaptionSuggestions();
    final Object other$captionSuggestions = other.getCaptionSuggestions();
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof ImageAnalysisResult;
  }
  ...
  public int hashCode() {
    final int PRIME = 59;
    int result = 1;
    final Object $imageDescription = this.getImageDescription();
    ...
    final Object $mood = this.getMood();
    ...
    final Object $suggestedTags = this.getSuggestedTags();
    result = result * PRIME + ($suggestedTags == null ? 43 : $suggestedTags.hashCode());
    final Object $captionSuggestions = this.getCaptionSuggestions();
  ...
  public String toString() {
    return "ImageAnalysisResult(imageDescription="
  ...
  /**
   * Creates a new {@code ImageAnalysisResult} instance.
   *
