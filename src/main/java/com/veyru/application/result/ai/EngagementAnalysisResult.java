...
public class EngagementAnalysisResult {
  ...
  public static class PostInsight {
    ...
    public boolean equals(final Object o) {
      ...
      if (!(o instanceof EngagementAnalysisResult.PostInsight)) return false;
      final EngagementAnalysisResult.PostInsight other =
          (EngagementAnalysisResult.PostInsight) o;
    ...
    protected boolean canEqual(final Object other) {
      return other instanceof EngagementAnalysisResult.PostInsight;
    }
    ...
    public String toString() {
      return "EngagementAnalysisResult.PostInsight(photoId="
          + this.getPhotoId()
          + ", caption="
          + this.getCaption()
          + ", imageUrl="
  ...
  public boolean equals(final Object o) {
    if (o == this) return true;
    if (!(o instanceof EngagementAnalysisResult)) return false;
    final EngagementAnalysisResult other = (EngagementAnalysisResult) o;
    if (!other.canEqual((Object) this)) return false;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof EngagementAnalysisResult;
  }
  ...
  @Override
  public String toString() {
    return "EngagementAnalysisResult(averageLikes="
