...
public class PhotoDetailResult {
  ...
  private List<LikeResult> likes;
  private List<CommentResult> comments;
  private List<String> tags;

  public PhotoDetailResult() {}
  ...
  public List<LikeResult> getLikes() {
    return this.likes;
  }
  ...
  public void setLikes(final List<LikeResult> likes) {
    this.likes = likes;
  }

  public void setComments(final List<CommentResult> comments) {
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof PhotoDetailResult)) return false;
    final PhotoDetailResult other = (PhotoDetailResult) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof PhotoDetailResult;
  }
