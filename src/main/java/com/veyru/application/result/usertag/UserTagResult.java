...
public class UserTagResult {
  ...
  public static class UserTagResponseBuilder {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder id(final String id) {
      this.id = id;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder photoId(final String photoId) {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder taggedUserId(final String taggedUserId) {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder taggedByUserId(final String taggedByUserId) {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder username(final String username) {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder userImageUrl(final String userImageUrl) {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder positionX(final Double positionX) {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder positionY(final Double positionY) {
     ...
     * @return {@code this}.
     */
    public UserTagResult.UserTagResponseBuilder createdAt(final Instant createdAt) {
      this.createdAt = createdAt;
      return this;
    }

    public UserTagResult build() {
    ...
    public String toString() {
      return "UserTagResult.UserTagResponseBuilder(id="
          + this.id
          + ", photoId="
          + this.photoId
          + ", taggedUserId="
  ...
  public static UserTagResult.UserTagResponseBuilder builder() {
    return new UserTagResult.UserTagResponseBuilder();
  }
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof UserTagResult)) return false;
    final UserTagResult other = (UserTagResult) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof UserTagResult;
  }
