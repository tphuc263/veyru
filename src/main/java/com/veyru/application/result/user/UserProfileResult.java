...
public class UserProfileResult {
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof UserProfileResult)) return false;
    final UserProfileResult other = (UserProfileResult) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof UserProfileResult;
  }
