...
public class ShareWithPhotoResult {
  private String id;
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof ShareWithPhotoResult)) return false;
    final ShareWithPhotoResult other = (ShareWithPhotoResult) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof ShareWithPhotoResult;
  }
  ...
  public String toString() {
    return "ShareWithPhotoResult(id="
        + this.getId()
        + ", photoId="
        + this.getPhotoId()
        + ", userId="
