...
public class RecommendedUserResult {
  private String id;
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof RecommendedUserResult)) return false;
    final RecommendedUserResult other = (RecommendedUserResult) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof RecommendedUserResult;
  }
  ...
  public String toString() {
    return "RecommendedUserResult(id="
        + this.getId()
        + ", username="
        + this.getUsername()
        + ", imageUrl="
