package com.veyru.service.graph;
...
public class Neo4jGraphService {
  private static final org.slf4j.Logger log = LoggerFactory.getLogger(Neo4jGraphService.class);
  ...
  public static class FeedNode {
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      if (!(o instanceof Neo4jGraphService.FeedNode)) return false;
      final Neo4jGraphService.FeedNode other = (Neo4jGraphService.FeedNode) o;
      ...
      if (java.lang.Double.compare(this.getRelevanceScore(), other.getRelevanceScore()) != 0)
        return false;
      ...
      final java.lang.Object this$authorImageUrl = this.getAuthorImageUrl();
      final java.lang.Object other$authorImageUrl = other.getAuthorImageUrl();
    ...
    protected boolean canEqual(final java.lang.Object other) {
      return other instanceof Neo4jGraphService.FeedNode;
    }
    ...
    public int hashCode() {
      ...
      final long $relevanceScore = java.lang.Double.doubleToLongBits(this.getRelevanceScore());
      ...
      final java.lang.Object $authorImageUrl = this.getAuthorImageUrl();
    ...
    public java.lang.String toString() {
      return "Neo4jGraphService.FeedNode(photoId="
          + this.getPhotoId()
          + ", imageUrl="
          + this.getImageUrl()
          + ", caption="
  ...
  public Neo4jGraphService(final Driver neo4jDriver) {
