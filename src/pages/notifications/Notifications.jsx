...
const Notifications = () => {
  ...
  const handleNavigate = (notification) => {
    if (notification.photoId) {
      window.location.href = `/home?photo=${notification.photoId}`;
  ...
  return (
    <div className="notifications-page">
      <div className="notifications-container">
        ...
        <div className="notification-list" onScroll={handleScroll} ref={listRef}>
          {notifications.length === 0 && !loading ? (
            <div className="no-notifications">
              <Bell size={64} strokeWidth={1} />
              <h3>Chưa có thông báo nào</h3>
              <p>Khi có ai đó tương tác với bài viết của bạn, bạn sẽ thấy ở đây.</p>
            </div>
          ) : (
            <>
              ...
              {!hasMore && notifications.length > 0 && (
                <div className="notification-end">Bạn đã xem hết thông báo</div>
              )}
            </>
          )}
        </div>
