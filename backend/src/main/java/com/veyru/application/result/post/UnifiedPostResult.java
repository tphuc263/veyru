package com.veyru.application.result.post;
 ...
 * unified feed
 */
public class UnifiedPostResult {
  private String id;
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof UnifiedPostResult)) return false;
    final UnifiedPostResult other = (UnifiedPostResult) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof UnifiedPostResult;
  }
